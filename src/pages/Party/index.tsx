...
import { List, Avatar, Modal, Button, Image, Radio, Table, Space, Tag } from 'antd';
import { DeleteTwoTone } from '@ant-design/icons';
import { ConBindObjArr, ifAccountExist, IconText, IconFont } from '@/utils/public/tools.tsx';
...
const PartyCourseList: React.FC<PartyCourseProps> = (props) => {
  ...
  const partyCourseListWAcc = ConBindObjArr(
    partyCourseList,
    AccountList,
    'account_id',
    'id',
  ...
  const CourseColumns = [
    ...
    },
    {
      ...
      render: (data: any) => {
        return <span>{data.nickname || <Tag color="red">用户注销</Tag>}</span>;
      },
    },
    {
      title: '关联商品',
      ...
      render: (data: any) => {
        return <span>{data.name || '暂无商品信息'}</span>;
      },
    },
    {
      title: '创建时间',
    ...
    >
              ...
              renderItem={(item) => (
                ...
                >
                  ...
                  />
                  {
                    ...
                    >
                      <strong>{item.course_brief}</strong>
                    </section>
                  }
                </List.Item>
              )}
      ...
      <section>
        {showDetails ? (
          <ShowPartyDetails
            show={showDetails}
            onCloseDrawer={setShowDetails}
            showInfos={showDetailsInfos}
          />
        ) : null}
      </section>
    </PageContainer>
